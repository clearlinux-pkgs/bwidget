...
Source0  : https://sourceforge.net/projects/tcllib/files/BWidget/1.9.14/bwidget-1.9.14.tar.gz
...
%prep
%setup -q -n bwidget-1.9.14
cd %{_builddir}/bwidget-1.9.14
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585154269
...
cp %{_builddir}/bwidget-1.9.14/LICENSE.txt %{buildroot}/usr/share/package-licenses/bwidget/b1e79a1551c340c3049efe258911e6699deb3581
%make_install
...
/usr/share/package-licenses/bwidget/b1e79a1551c340c3049efe258911e6699deb3581
